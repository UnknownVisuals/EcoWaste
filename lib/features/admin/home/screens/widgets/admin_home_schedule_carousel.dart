...
import 'package:eco_waste/features/admin/home/controllers/home_controller.dart';
...
class AdminHomeScheduleCarousel extends StatelessWidget {
  const AdminHomeScheduleCarousel({super.key, required this.desaId});

  final String desaId;

  @override
  Widget build(BuildContext context) {
    final AdminHomeController homeController = Get.put(AdminHomeController());
