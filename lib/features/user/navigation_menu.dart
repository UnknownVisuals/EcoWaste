...
class UserNavigationMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final userNavigationContoller = Get.put(UserNavigationController());
    ...
    return Obx(() {
      ...
      return Scaffold(
        bottomNavigationBar: Obx(
          () => GNav(
            selectedIndex: userNavigationContoller.selectedIndex.value,
            onTabChange: (index) =>
                userNavigationContoller.selectedIndex.value = index,
            haptic: true,
            gap: 8,
            iconSize: 24,
            tabBorderRadius: 100,
        ...
        body: Obx(
          () => IndexedStack(
            index: userNavigationContoller.selectedIndex.value,
            children: userNavigationContoller.screens,
          ),
        ),
      );
    });
