...
class TransactionsInput extends StatelessWidget {
  ...
  Future<void> _submitTransaction(
    ...
    // Get the selected waste category model
    final selectedWasteCategoryModel = wasteCategoryController.wasteCategories
        .firstWhere((category) => category.id == selectedWasteCategory.value);

    // Create user model for transaction
    ...
    final transaction = TransactionModel(
      ...
      wasteCategory: selectedWasteCategoryModel,
